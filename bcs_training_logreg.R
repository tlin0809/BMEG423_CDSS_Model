...
train_X <- SEPSISdat_train[, cols, drop = FALSE]
test_X  <- SEPSISdat_test[,  cols, drop = FALSE]
...
SEPSISdat_train$probSepsisLR <- predict(logReg,newdata= train_X)
SEPSISdat_test$probSepsisLR <- predict(logReg,newdata= test_X)
